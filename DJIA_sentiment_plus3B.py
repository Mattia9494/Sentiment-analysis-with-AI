...
verbose = 1
Base_Dir = ''
Weights_Name = 'DJIA_weights_plus3B.hdf5'
Model_Name = 'DJIA_model_plus3B.h5'
...
#read csv file
DJIA = pd.read_csv("Combined_News_DJIA_plus3B.csv", usecols=['Date', 'Label','Top1', 'Top2', 'Top3', 'Top4', 'Top5',
