...
verbose = 1
Base_Dir = ''
Weights_Name = 'DJIA_weights_plus2.hdf5'
Model_Name = 'DJIA_model_plus2.h5'
...
#read csv file
DJIA = pd.read_csv("Combined_News_DJIA_plus2.csv", usecols=['Date', 'Label','Top1', 'Top2', 'Top3', 'Top4', 'Top5',
