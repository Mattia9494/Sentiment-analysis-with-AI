...
verbose = 1
Base_Dir = ''
Weights_Name = 'DJIA_weights_plus2B.hdf5'
Model_Name = 'DJIA_model_plus2B.h5'
...
#read csv file
DJIA = pd.read_csv("Combined_News_DJIA_plus2B.csv", usecols=['Date', 'Label','Top1', 'Top2', 'Top3', 'Top4', 'Top5',
